...
# ─── DPIA-Robotics-2026 §6: chain_status sin Bearer ni secretos ──────────────
def _chain_status() -> str:
    """
    Expone estado blockchain sin revelar secretos.
    DPIA §6 (Observabilidad): disabled | ready | misconfigured.
    disabled     → CASTUO_ROBOTICS_LAB_CHAIN_REGISTER != "1"
    misconfigured → flag activo pero faltan variables requeridas
    ready         → flag activo y todas las variables presentes
    """
...
async def health():
    return {
        ...
        "sovereignty": "EU",
        # DPIA-Robotics-2026 §6: expuesto sin autenticación
