...
- Gates especializados de cumplimiento (CTAEX tecnico + legal) ejecutables desde Makefile.
- Paquete de auditoria exhaustivo con portada ejecutiva, ZIP, checksum e integridad criptografica por archivo.
- Escaneo anti-secretos sobre evidencias antes de emitir bundle auditable.
