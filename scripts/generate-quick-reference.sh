...
OUTPUT="docs/QUICK-REFERENCE.md"
...
OPEN_ISSUES_URL="https://github.com/${GITHUB_REPOSITORY:-Traky12/Castuo-system}/issues"
PR_URL="https://github.com/${GITHUB_REPOSITORY:-Traky12/Castuo-system}/pulls"

cat > "$OUTPUT" <<EOF
# Resumen Visual - CASTUO-SYSTEM 2040

Actualizado: $TODAY
Ultimo cambio: $LAST_COMMIT
...
- Pull Requests: $PR_URL
- Issues: $OPEN_ISSUES_URL
