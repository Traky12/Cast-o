...
- [HETZNER-K8S-DEPLOY.md](docs/HETZNER-K8S-DEPLOY.md) — Guía de despliegue en producción (Hetzner K8s)
...
| **Aspecto**               | **Estado**       | **Detalles**                                                                                     | **Próximos Pasos**                          |
|---------------------------|------------------|-------------------------------------------------------------------------------------------------|--------------------------------------------|
| **Versión**               | ✅ **v3.1.0**    | Lanzamiento estable con TRL9 certificado.                                                     | v3.2.0 (Integración con Stripe).            |
| **Despliegue**            | ✅ **Producción** | Desplegado en Hetzner CX22 (Kubernetes).                                                        | Escalar a 3 réplicas en Hetzner.            |
| **Documentación**         | ✅ **Completa**  | README, API Reference, Architecture, Compliance.                                               | Añadir guías de usuario para CTAEX.         |
| **Tests**                 | ✅ **132 Passing** | Cobertura del 95% con pytest.                                                                   | Añadir tests E2E para workflows de n8n.     |
| **Comunidad**             | ⚠️ **En crecimiento** | 5 colaboradores internos (CTAEX, Fundecyt).                                                     | Abrir a contribuciones externas.            |
| **Soporte**               | ✅ **Activo**     | Soporte para CTAEX y FoodLab.                                                                   | Crear canal de Discord para la comunidad.   |

---
**🔹 Última actualización:** 2026-05-10  
**🔹 Versión estable:** <a href="https://github.com/Traky12/Castuo-system/releases/tag/v3.1.0">v3.1.0</a>  
**🔹 Roadmap:** <a href="https://github.com/Traky12/Castuo-system/milestones">Ver milestones</a>
